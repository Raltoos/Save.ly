...
const Profile = () => {
  ...
  return (
    <div className="relative w-screen h-screen flex flex-col items-center overflow-hidden pb-20 text-black">
      <div className="absolute bg-gradient-to-b from-[#429690] to-[#2A7C76] w-screen h-[230px] rounded-b-[40%] flex flex-col items-center justify-between p-5 text-white">
      ...
      <div className="w-screen bg-white mt-[230px] flex flex-col items-center">
        <div className="flex flex-col mt-12 items-center">
          <span className="text-xl font-semibold">Anuj Parwal</span>
          <span>@Raltoos</span>
        </div>
