...
const Analytics = () => {
  ...
  return (
    <div className="relative w-screen h-screen flex flex-col items-center bg-gray-100 overflow-hidden overflow-y-auto pb-20 text-black">
      <div className="absolute bg-gradient-to-b from-[#429690] to-[#2A7C76] w-screen h-[180px] rounded-b-[20%] flex items-start justify-between p-5 text-white">
          ...
          {filteredTransactions
            ...
            .map((trx, idx) => (
              ...
              >
                ...
                <p className="text-lg font-semibold text-[#2A7C76]">
                  ₹{trx.amount}
                </p>
              </div>
            ))}
